...
| US-F003-04 | 代码推送完成后，系统可以基于提交范围刷新受影响代码节点和 AI 描述 |
...
| `git post-push-refresh` | 按 commit 或分支触发推送后图谱和 AI 描述刷新 |
...
| BR-F003-07 | 推送后必须支持按 commit 或分支触发图谱刷新和 AI 描述刷新 | AC-F003-04 |
...
| `ai_descriptions_updated` | 刷新的 AI 描述数量 |
...
| AC-F003-04 | 推送成功且存在新增 commit | 执行 `git post-push-refresh` | 受影响代码节点、关系链路及 AI 描述被刷新 |
...
| TC-F003-05 | P0 | 推送成功后按 commit 范围刷新代码节点和 AI 描述 |
