...
| --- | --- | --- | --- | --- |
| F001 | 文档绑定切换 | `features/F001-doc-binding-switch.md` | P0 | 删除语义、命令命名、清理范围和导入策略已确认 |
...
| 评估器结论 | 未执行独立子智能体评估 |
| 最近评估时间 | 2026-05-11 |
| 主要风险 | 实现时需确保 `doc binding switch` 只清理绑定数据字段且不自动导入 |
